...
<html>
    <head>
        <title>Jenkins Deployment Training-Test Pipeline</title>
    ...
    <body>
        <nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3;width:250px;" id="mySidebar">
            ...
            <a class="w3-bar-item w3-button" href="#">Link 1-Test 1</a>
            <a class="w3-bar-item w3-button" href="#">Link 2 -Test 2</a>
            <a class="w3-bar-item w3-button" href="#">Link 3 -Test 3</a>
            <a class="w3-bar-item w3-button" href="#">Link 4-Test 4</a>
            <a class="w3-bar-item w3-button" href="#">Link 5-Test 5</a>
            <a class="w3-bar-item w3-button" href="#">Link 6-Test 6</a>
            <a class="w3-bar-item w3-button" href="#">Link 7-Test 7</a>
            ...
            <a class="w3-bar-item w3-button" href="#">Link 13-Test 13</a>
            <a class="w3-bar-item w3-button" href="#">Link 14-Test 14</a>
            <a class="w3-bar-item w3-button" href="#">Link 15-Test 15</a>
            <a class="w3-bar-item w3-button" href="#">Link 16-Test 16</a>
            <a class="w3-bar-item w3-button" href="#">Link 17-Test 17</a>
            <a class="w3-bar-item w3-button" href="#">Link 18-Test 18</a>
            <a class="w3-bar-item w3-button" href="#">Link 19-Test 19</a>
            <a class="w3-bar-item w3-button" href="#">Link 20-Test 20</a>
            <a class="w3-bar-item w3-button" href="#">Link 21-Test 21</a>
            <a class="w3-bar-item w3-button" href="#">Link 22-Test 22</a>
            <a class="w3-bar-item w3-button" href="#">Link 23-Test 23</a>
            <a class="w3-bar-item w3-button" href="#">Link 24-Test 24</a>
            <div>
